...
Frame_pipeline::Frame_pipeline(Engine& engine)
	: m_engine(engine)
{
}
...
void Frame_pipeline::load_resource()
{
	...
	m_mesh_novb_renderer = std::make_unique<Mesh_novb_renderer>(m_engine, *this);
	m_mesh_novb_renderer->load_resource();
