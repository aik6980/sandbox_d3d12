...
HWND CreateMainWindow(HINSTANCE hInstance, int nCmdShow, const wstring& className, const CRect& rect)
{
    ...
    HWND hwnd = CreateWindowEx(NULL, className.c_str(), L"Win32Project", WS_OVERLAPPEDWINDOW, 0, 100, windowRect.right - windowRect.left, windowRect.bottom - windowRect.top,
