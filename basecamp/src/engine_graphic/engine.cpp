...
void Engine::draw()
{
    ...
    m_render_device->commmand_list()()->ResourceBarrier(1, &CD3DX12_RESOURCE_BARRIER::Transition(&m_render_device->curr_backbuffer(), D3D12_RESOURCE_STATE_PRESENT, D3D12_RESOURCE_STATE_RENDER_TARGET));
    ...
    // Indicate a state transition on the resource usage.
    m_render_device->commmand_list()()->ResourceBarrier(1, &CD3DX12_RESOURCE_BARRIER::Transition(&m_render_device->curr_backbuffer(), D3D12_RESOURCE_STATE_RENDER_TARGET, D3D12_RESOURCE_STATE_PRESENT));
