...
; Position_grid            0   xyzw        1     NONE   float   xyzw
;
; shader hash: 32a25ad094843333d6de4730b59849c1
;
...
!2 = !{i32 1, i32 5}
!3 = !{!"vs", i32 6, i32 0}
!4 = !{[10 x i32] [i32 8, i32 8, i32 17, i32 34, i32 68, i32 136, i32 0, i32 0, i32 0, i32 0]}
...
!14 = !{i32 1, !"Position_grid", i8 9, i8 0, !9, i8 2, i32 1, i8 4, i32 1, i8 0, !10}
!15 = !{i32 0, i64 1}
